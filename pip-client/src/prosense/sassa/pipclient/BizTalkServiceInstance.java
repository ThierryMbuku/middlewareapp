 ...
 * 
 */
@WebServiceClient(name = "BizTalkServiceInstance", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/Users/Shared/Previously Relocated Items/Security/Deepak/Work/gitlocal/SASSA-BIAM/middleware/pip-client/service/PersonIdentiyService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BIZTALKSERVICEINSTANCE_QNAME = new QName("http://tempuri.org/", "BizTalkServiceInstance");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/Shared/Previously Relocated Items/Security/Deepak/Work/gitlocal/SASSA-BIAM/middleware/pip-client/service/PersonIdentiyService.wsdl");
     ...
     * 
     * @return
     *     returns PersonIdentiyService
     */
    @WebEndpoint(name = "BasicHttpBinding_ITwoWayAsync")
    public PersonIdentiyService getBasicHttpBindingITwoWayAsync() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_ITwoWayAsync"), PersonIdentiyService.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_ITwoWayAsync")
    public PersonIdentiyService getBasicHttpBindingITwoWayAsync(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_ITwoWayAsync"), PersonIdentiyService.class, features);
    }
